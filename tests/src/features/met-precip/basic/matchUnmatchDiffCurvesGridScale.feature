Feature: Match Unmatch Diff Curves Grid Scale

    As an unauthenticated user to the app,
    with the app in its default state so that the plots are Grid Scale,
    ...
    @watch
    Scenario: matchUnmatchDiffCurvesGridScale
