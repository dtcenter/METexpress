Feature: Add Remove Two Scatters
    ...
    Scenario: addRemoveTwoScatters
        ...
        When I change the "variable" parameter to "T"
        Then the "variable" parameter value matches "T"
        When I change the "y-statistic" parameter to "RMSE"
        Then the "y-statistic" parameter value matches "RMSE"
        When I change the "y-variable" parameter to "DPT"
        Then the "y-variable" parameter value matches "DPT"
