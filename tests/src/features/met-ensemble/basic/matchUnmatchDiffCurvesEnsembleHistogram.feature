Feature: Match Unmatch Diff Curves EnsembleHistogram
    ...
    @watch
    Scenario: matchUnmatchDiffCurvesEnsembleHistogram
        ...
        When I change the "variable" parameter to "DPT"
        Then the "variable" parameter value matches "DPT"
        When I click the "Add Curve" button
