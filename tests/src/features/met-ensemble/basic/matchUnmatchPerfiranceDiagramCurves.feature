Feature: Match Unmatch Performance Diagram Curves

    As an unauthenticated user to the app,
    with the app in its default state so that the plots are Performance Diagram,
    ...
    @watch
    Scenario: matchUnmatchPerformanceDiagramCurves
