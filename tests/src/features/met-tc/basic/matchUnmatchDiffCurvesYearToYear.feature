Feature: Match Unmatch Diff Curves Year To Year
    ...
    Scenario: matchUnmatchDiffCurvesYearToYear
        ...
        When I change the "data-source" parameter to "Prev GFS Ensemble Mean Forecast Interpolated Ahead 6 hr"
        Then the "data-source" parameter value matches "Prev GFS Ensemble Mean Forecast Interpolated Ahead 6 hr"
