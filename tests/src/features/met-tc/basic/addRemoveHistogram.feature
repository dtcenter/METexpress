Feature: Add Remove Histogram
    ...
    Scenario: addRemoveHistogram
        ...
        When I change the "data-source" parameter to "AEMI: GFS Ensemble Mean Forecast"
        Then the "data-source" parameter value matches "AEMI: GFS Ensemble Mean Forecast"
