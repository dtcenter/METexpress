...
const doCurveParams = function () {
    ...
    var thisDB;
    try {
        rows = matsDataQueryUtils.simplePoolQueryWrapSynchronous(sumPool, "select distinct db from anomalycor_metexpress_metadata;");
        ...
        matsCollections["variable"].insert(
            {
                ...
                dependentNames: ["region", "forecast-length", "level", "interp-method", "scale", "description", "dates", "curve-dates"],
                controlButtonCovered: true,
                unique: false,
...
Meteor.startup(function () {
    ...
    const mdr = new matsTypes.MetaDataDBRecord("sumPool", "metexpress_metadata", ['anomalycor_metexpress_metadata', 'anomalycor_database_groups']);
    try {
