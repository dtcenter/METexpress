...
const doCurveParams = function () {
        ...
        matsCollections["variable"].insert(
            {
                ...
                dependentNames: ["region", "forecast-length", "level", "threshold", "interp-method", "scale", "description", "dates", "curve-dates"],
                controlButtonCovered: true,
                unique: false,
    ...
    if (levelOptions.indexOf("SFC") !== -1) {
        levelDefault = "SFC";
    } else if (levelOptions.indexOf("Z0") !== -1) {
        levelDefault = "Z0";
...
const doCurveTextPatterns = function () {
    ...
    if (matsCollections.CurveTextPatterns.find().count() == 0) {
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "group", "database", "data-source", "region", "statistic", "variable", "threshold", "interp-method", "scale", "valid-time", "average", "forecast-length", "level", "description", "aggregation-method"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "group", "database", "data-source", "region", "statistic", "variable", "threshold", "interp-method", "scale", "dieoff-type", "valid-time", "utc-cycle-start", "level", "description", "aggregation-method", "curve-dates"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "group", "database", "data-source", "region", "statistic", "variable", "interp-method", "scale", "forecast-length", "valid-time", "level", "description", "aggregation-method", "curve-dates"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "group", "database", "data-source", "region", "statistic", "variable", "threshold", "interp-method", "scale", "forecast-length", "level", "description", "aggregation-method", "curve-dates"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "group", "database", "data-source", "region", "statistic", "variable", "threshold", "interp-method", "scale", "valid-time", "forecast-length", "level", "description", "aggregation-method", "curve-dates"
            ],
            groupSize: 6
        });
        matsCollections.CurveTextPatterns.insert({
            ...
            displayParams: [
                "label", "group", "database", "data-source", "region", "statistic", "variable", "threshold", "interp-method", "scale", "valid-time", "forecast-length", "level", "aggregation-method", "description"
            ],
            groupSize: 6
        });
    }
