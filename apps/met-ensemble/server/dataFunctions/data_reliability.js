...
dataReliability = function (plotParams, plotFunction) {
    ...
    for (curveIndex = 0; curveIndex < curvesLength; curveIndex++) {
        ...
        if (curveIndex < dReturn.length) {
            ...
            throw new Error("INFO:  Difference curves are not supported for Reliability curves, as they do not feature consistent x or y values across all curves.");
        }
