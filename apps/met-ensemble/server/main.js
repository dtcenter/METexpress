...
const doCurveParams = function () {
    ...
    var thisDB;
    try {
        rows = matsDataQueryUtils.simplePoolQueryWrapSynchronous(sumPool, "select distinct db from ensemble_metexpress_metadata;");
...
Meteor.startup(function () {
    ...
    const mdr = new matsTypes.MetaDataDBRecord("sumPool", "metexpress_metadata", ['ensemble_metexpress_metadata', 'ensemble_database_groups']);
    try {
