...
const doCurveParams = function () {
    ...
    var thisDB;
    try {
        rows = matsDataQueryUtils.simplePoolQueryWrapSynchronous(sumPool, "select distinct db from cyclone_metexpress_metadata;");
...
Meteor.startup(function () {
    ...
    const mdr = new matsTypes.MetaDataDBRecord("sumPool", "metexpress_metadata", ['cyclone_metexpress_metadata', 'cyclone_database_groups']);
    try {
