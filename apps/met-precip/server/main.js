                ...
                for (var ptidx = 0; ptidx < validPlotTypes.length; ptidx++) {
                    ...
                    for (var vsidx = 0; vsidx < theseValidStats.length; vsidx++) {
                        ...
                        if (variableValuesMap[thisDB][model][thisPlotType][thisValidStat] === undefined) {
                            ...
                            scaleOptionsMap[thisDB][model][thisPlotType][thisValidStat] = {};
                            sourceOptionsMap[thisDB][model][thisPlotType][thisValidStat] = {};
                    ...
                    if (variableValuesMap[thisDB][model][thisPlotType][jsonFriendlyVariable] === undefined) {
                        // if we haven't encountered this variable for this plot type yet, just store the variable-dependent arrays
                            ...
                            scaleOptionsMap[thisDB][model][thisPlotType][thisValidStat][jsonFriendlyVariable] = scalesArr;
                            sourceOptionsMap[thisDB][model][thisPlotType][thisValidStat][jsonFriendlyVariable] = sourceArr;
                        ...
                        // if we have encountered this variable for this plot type, we need to take the unions of existing and new arrays
                            ...
                            scaleOptionsMap[thisDB][model][thisPlotType][thisValidStat][jsonFriendlyVariable] = _.union(scaleOptionsMap[thisDB][model][thisPlotType][thisValidStat][jsonFriendlyVariable], scalesArr);
                            sourceOptionsMap[thisDB][model][thisPlotType][thisValidStat][jsonFriendlyVariable] = _.union(sourceOptionsMap[thisDB][model][thisPlotType][thisValidStat][jsonFriendlyVariable], sourceArr);
        ...
        matsCollections.CurveParams.insert(
            {
                ...
                options: scaleOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatistic][Object.keys(scaleOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatistic])[0]],
                superiorNames: ['database', 'data-source', 'plot-type', 'statistic', 'variable'],
                controlButtonCovered: true,
                unique: false,
                default: scaleOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatistic][Object.keys(scaleOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatistic])[0]][0],
                controlButtonVisibility: 'block',
                displayOrder: 2,
                displayPriority: 1,
                displayGroup: 4
        ...
        matsCollections.CurveParams.insert(
            {
                ...
                options: sourceOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatistic][Object.keys(sourceOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatistic])[0]],
                superiorNames: ['database', 'data-source', 'plot-type', 'statistic', 'variable'],
                controlButtonCovered: true,
                unique: false,
                default: sourceOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatistic][Object.keys(sourceOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatistic])[0]][0],
                controlButtonVisibility: 'block',
