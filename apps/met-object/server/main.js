...
const doCurveParams = function () {
    ...
    const masterStatsOptionsMap = {
        "mode_obj_pair": {
            ...
            'Area-weighted ratio of simple objects that are forecast objects': ['mode_single'],
            'Area-weighted ratio of simple objects that are observation objects': ['mode_single'],
            ...
            'Area-weighted ratio of simple forecast objects that are matched': ['mode_single'],
            'Area-weighted ratio of simple forecast objects that are unmatched': ['mode_single'],
            'Area-weighted ratio of simple observed objects that are matched': ['mode_single'],
            'Area-weighted ratio of simple observed objects that are unmatched': ['mode_single'],
            'Area-weighted ratio of simple matched objects that are forecast objects': ['mode_single'],
            'Area-weighted ratio of simple matched objects that are observed objects': ['mode_single'],
            'Area-weighted ratio of simple unmatched objects that are forecast objects': ['mode_single'],
            'Area-weighted ratio of simple unmatched objects that are observed objects': ['mode_single'],
            ...
            'Area-weighted ratio of cluster objects that are forecast objects': ['mode_single'],
            'Area-weighted ratio of cluster objects that are observation objects': ['mode_single'],
            'Area-weighted ratio of simple forecasts to simple observations (frequency bias)': ['mode_single'],
            'Area-weighted ratio of simple observations to simple forecasts (1 / frequency bias)': ['mode_single'],
            ...
            'Area-weighted ratio of forecast cluster objects to forecast simple objects': ['mode_single'],
            'Area-weighted ratio of forecast simple objects to forecast cluster objects': ['mode_single'],
            'Area-weighted ratio of observed cluster objects to observed simple objects': ['mode_single'],
            'Area-weighted ratio of observed simple objects to observed cluster objects': ['mode_single'],
        }
    };
        ...
        matsCollections["variable"].insert(
            {
                ...
                dependentNames: ["forecast-length", "level", "threshold", "radius", "scale", "description", "dates", "curve-dates"],
                controlButtonCovered: true,
                unique: false,
    ...
    // these defaults are app-specific and not controlled by the user
    minDate = dbDateRangeMap[defaultDB][defaultModel][defaultPlotType][defaultStatType][Object.keys(descrOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatType])[0]].minDate;
    maxDate = dbDateRangeMap[defaultDB][defaultModel][defaultPlotType][defaultStatType][Object.keys(descrOptionsMap[defaultDB][defaultModel][defaultPlotType][defaultStatType])[0]].maxDate;
